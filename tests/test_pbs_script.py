...
class TestPBSScript(unittest.TestCase):
    ...
    def test_init_name_value_error(self):
        self.assertRaises(
            ValueError, PbsScript, name=None, project_id="P001", num_nodes=5, processes_per_node=1, max_time="20:30:30"
        )

    def test_init_project_id_value_error(self):
        self.assertRaises(
            ValueError, PbsScript, name="test1", project_id=None, num_nodes=5, processes_per_node=1, max_time="20:30:30"
        )

    def test_init_max_time_value_error(self):
        self.assertRaises(
            ValueError, PbsScript, name="test2", project_id="P001", num_nodes=5, processes_per_node=10, max_time=None
        )
    ...
    def test_get_render_required_directives_block_for_narwhal_compute_node(self):
        ...
        self.assertIn(
            f"#PBS -l select={pbs_script.num_nodes}:"
    ...
    def test_get_render_required_directives_block_for_narwhal_gpu_node(self):
        ...
        res = pbs_script.render_required_directives_block()
        self.assertIn(
            f'#PBS -l select={pbs_script.num_nodes}:ncpus={NODE_TYPES["narwhal"]["compute"]}:'
            f"mpiprocs={pbs_script.processes_per_node}",
            res,
        )
    ...
    def test_get_render_required_directives_block_for_narwhal_bigmem_node(self):
        ...
        res = pbs_script.render_required_directives_block()
        self.assertIn(
            f'#PBS -l select={pbs_script.num_nodes}:ncpus={NODE_TYPES["narwhal"]["bigmem"]}:'
            f"mpiprocs={pbs_script.processes_per_node}",
            res,
        )
    ...
    def test_get_render_required_directives_block_for_carpenter_compute_node(self):
        ...
        expected = (
            f'#PBS -l select={pbs_script.num_nodes}:ncpus={NODE_TYPES["carpenter"]["compute"]}:'
            f"mpiprocs={pbs_script.processes_per_node}"
        )
    ...
    def test_get_render_required_directives_block_for_carpenter_gpu_node(self):
        ...
        expected = (
            f'#PBS -l select={pbs_script.num_nodes}:ncpus={NODE_TYPES["carpenter"]["gpu"]}:'
    ...
    def test_get_render_required_directives_block_for_carpenter_bigmem_node(self):
        ...
        expected = (
            f'#PBS -l select={pbs_script.num_nodes}:ncpus={NODE_TYPES["carpenter"]["bigmem"]}:'
